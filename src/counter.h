...
extern void counter_P(counter_t);

extern void counter_P_n(counter_t, int);

extern void counter_V(counter_t);

extern void counter_V_n(counter_t, int);

extern void counter_V_all(counter_t);
